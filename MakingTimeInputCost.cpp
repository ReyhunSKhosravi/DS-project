                    ...
                    if(preTran == tempTran){
                        if(tempTran == "BUS"){
                            if(preColor != tempColor){
                                ...
                                if(!findDuplicate("inputtime", templine))
                                inputTimeCost <<  preOrigin << "\t" << preDest << "\t" << ((stoi(tempWeight) * 4) + 0 ) << "\t"<< tempTran << "\t" << tempColor << "\n";
                            }
                        }
                            ...
                            if(preColor != tempColor){
                                ...
                                if(!findDuplicate("inputtime", templine))
                                inputTimeCost <<  preOrigin << "\t" << preDest << "\t" << ((stoi(tempWeight) * 1) + 0 ) << "\t"<< tempTran << "\t" << tempColor << "\n";
                            }
                        }
                            ...
                            if(preColor != tempColor){
                                ...
                                if(!findDuplicate("inputtime", templine))
                                inputTimeCost <<  preOrigin << "\t" << preDest << "\t" << ((stoi(tempWeight) * 2) + 5) << "\t"<< tempTran << "\t" << tempColor << "\n";
                            }
                            else{
                                templine =  (preOrigin + "\t" + preDest + "\t" + to_string(((stoi(tempWeight) * 2) + 0 )) + "\t" + tempTran + "\t" + tempColor);
                                if(!findDuplicate("inputtime", templine))
                                inputTimeCost <<  preOrigin << "\t" << preDest << "\t" << ((stoi(tempWeight) * 2) + 0 ) << "\t"<< tempTran << "\t" << tempColor << "\n";
                            }
                        }
                    }
